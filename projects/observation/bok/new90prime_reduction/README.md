...
ccdtools provides simple CCD data reduction helpers and a small CLI for detecting and masking bad columns in amplifier-specific images.

## Features

- Scan a directory of FITS files and categorize bias/dark/flat frames (heuristic scanner)
...
- The FITS scanner is heuristic-based and may need tuning for your headers.
...
If you'd like, I can run the `git` commands here for you to initialize and commit locally (I won't create the remote on GitHub)."}