...
#tilt-map-overlay .amp-detail-pane b {{ color: #FFB74D; }}
#tilt-map-overlay .amp-detail-pane .muted {{ color: #aaa; font-size: 11px; margin-top: 3px; }}
...
#tilt-map-overlay .amp-detail-pane .error {{ color: #ef5350; margin-top: 6px; }}
#tilt-map-overlay .amp-detail-pane .loading {{ color: #90CAF9; margin-top: 6px; }}
    ...
    if (gd) {{
        ...
        gd.on('plotly_click', function(data) {{
            ...
            .then(function(result) {{
                ...
                var d = result.data;
                var html = renderAmpFwhmTable(d);
                document.getElementById('amp-detail-content').innerHTML = html;
            }})
            .catch(function(err) {{
                loadAmpFwhmFromEcsv(frame)
                    ...
                    .catch(function(fallbackErr) {{
                        document.getElementById('amp-detail-content').innerHTML =
                            ...
                            err.message + '<br>' + fallbackErr.message + '</div>';
                    }});
            }});
        }});
